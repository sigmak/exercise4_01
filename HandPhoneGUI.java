...
//Âü°í : http://www.sourcecodesworld.com/source/show.asp?ScriptID=1181
class HandPhoneGUI implements ActionListener{
	...
	public static void main(String args[]){
		HandPhoneGUI add = new HandPhoneGUI();
	}
	...
	public void actionPerformed(ActionEvent ae){
		if(ae.getActionCommand() == "Add New Contact"){
			...
			JOptionPane.showMessageDialog(frame, "About AddressBook:Created By Rahul ChouhanComputer Engg, IET-DAVV,Indore.Website:http://www.Rahul Chouhan.tk","About Address Book",JOptionPane.INFORMATION_MESSAGE);
		}
...
class Contact implements Serializable{
	...
	public void setDetails(String Name, String Age, String PhoneNo){
		this.Name = Name;
		this.Age  = Age;
...
class OperationHandler implements ListSelectionListener,
    ...
    public void AddNew(){
        ...
        txtPhoneNo = new JTextField(10);
               ...
               centerPane.add(lblAge);
               centerPane.add(txtAge);
...
JOptionPane.showMessageDialog(newFrame,"Entries Empty! Fill in the required entries to save Contact.", "EntriesEmpty", JOptionPane.INFORMATION_MESSAGE);
...
contact.setDetails(txtName.getText(),txtPhoneNo.getText());
...
"Contact Found!", "Search Result!", JOptionPane.INFORMATION_MESSAGE);
           	                ...
           	                {
           	                   JOptionPane.showMessageDialog(newFrame, "NoSuch Contact Found!", "Search Result!",JOptionPane.INFORMATION_MESSAGE);
           	                }
